...
<body>
    ...
    <section>
        ...
        <p>Impossible de me souvenir ce qui me décide en 2017 de me lancer dans l'impression 3D
            <br />Ma pratique du drone, les forums et autres pages facebook où commencent à fleurir des designs
            d’accessoires/protections/mods ?
            ...
            <br />Juste le plaisir d’un challenge technique et des heures de : soudure, montage, recherche et
            bidouillage à venir?
        ...
        <p>Évidemment je commence par me renseigner sur les imprimantes prêtes à l’emploi,
            puis quand on me dit qu’il existe des projets opensource, avec tutoriel et liste complète de matériel, plus
            aucun doute :
            <br /><strong>Je veux construire la mienne !</strong>
        </p>
        <img class="borderedimg" src="../img/imp3d/imp3d_montage.png" />
        <p>Me voilà donc commençant par commander quelques pièces sur 3dHub pour rencontrer quelqu’un qui a une
            imprimante et s’en sert
            <br />Puis trouver quelqu’un d’autre pour m’imprimer le kit de pièces de base
            <br />et c’est partie pour un colis tous les deux jours, du paquet de 4 vis M4x30mm venu de l’autre bout du
            monde...
        ...
        <p>Biensûr il y a l’utilisation de la machine, mais améliorer la machine elle-même fait une grande partie de mon
            plaisir :
        ...
        <p>Voilà l’imprimante dans son jus actuel, opérationnelle dans mon garage, désormais contrôlée par une SKR v.1.4
            avec un firmware klipper
